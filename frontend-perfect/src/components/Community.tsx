...
const defaultCommunity: CommunityData = {
  ...
  influencers: [
    ...
    { name: "Isla Montgomery", videoUrl: "https://storage.googleapis.com/webild/default/templates/skincare-luxury/influencer-isla.mp4" },
    { name: "Zara Kimani", videoUrl: "https://storage.googleapis.com/webild/default/templates/skincare-luxury/influencer-zara.mp4" },
    { name: "Nadia Petrova", videoUrl: "https://storage.googleapis.com/webild/default/templates/skincare-luxury/influencer-nadia.mp4" }
  ]
};
...
export default function Community() {
  ...
  return (
    <section aria-label="Community section" className="py-20">
