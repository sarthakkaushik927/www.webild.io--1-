...
export const authService = {
  async signUp(email: string, password: string, fullName: string, phone?: string, role: 'customer' | 'admin' | 'chef' | 'waiter' = 'customer') {
...
export const adminService = {
  ...
  async deleteUser(userId: string) {
    ...
    await apiDeleteAuth(`/api/users/${userId}`, token);
    return { error: null };
  },
};
