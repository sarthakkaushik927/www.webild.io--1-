...
var i = e(),
  a = ({
    ...
    let d = (0, i.jsx)(`a`, {
      ...
      onClick: n(o, s),
      className: r(
        `group flex items-center justify-center h-10 px-6 text-sm rounded cursor-pointer transition-transform duration-300 ease-out md:hover:scale-90 md:hover:-rotate-3`,
        a === `primary`
