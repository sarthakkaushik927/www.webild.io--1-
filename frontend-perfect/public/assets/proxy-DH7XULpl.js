...
var oe = (e) => (t) => t <= 0.5 ? e(2 * t) / 2 : (2 - e(2 * (1 - t))) / 2,
  ...
  O = { value: null, addProjectionMetrics: null };
function we(e, t) {
  let n = new Set(),
    r = new Set(),
    i = !1,
...
function Ee(e, t) {
  let n = !1,
    ...
    a = () => (n = !0),
    o = Ce.reduce((e, n) => ((e[n] = we(a, t ? n : void 0)), e), {}),
    {
      setup: s,
      read: c,
      resolveKeyframes: l,
...
var {
    ...
    state: j,
    steps: De,
  } = Ee(typeof requestAnimationFrame < `u` ? requestAnimationFrame : x, !0),
  Oe;
function ke() {
  Oe = void 0;
}
var M = {
    now: () => (
      Oe === void 0 &&
        M.set(
          j.isProcessing || g.useManualTiming ? j.timestamp : performance.now()
        ),
      Oe
    ),
    set: (e) => {
      (Oe = e), queueMicrotask(ke);
    },
  },
...
var He =
  ...
  Ue = (e, t) => (n) =>
    !!(
      (typeof n == `string` && He.test(n) && n.startsWith(e)) ||
...
var Ye = { test: Ue(`#`), parse: Je, transform: qe.transform },
  Xe = (e) => ({
    test: (t) =>
  ...
  L = {
    ...
    parse: (e) =>
      qe.test(e) ? qe.parse(e) : et.test(e) ? et.parse(e) : Ye.parse(e),
    transform: (e) =>
      typeof e == `string`
        ? e
...
function nt(e) {
  return (
    isNaN(e) &&
    typeof e == `string` &&
    (e.match(Be)?.length || 0) + (e.match(tt)?.length || 0) > 0
  );
}
var rt = `number`,
  it = `color`,
  ...
  return {
    ...
    split: t
      .replace(
        ...
        (e) => (
          L.test(e)
            ? (r.color.push(a), i.push(it), n.push(L.parse(e)))
            : e.startsWith(ot)
            ? (r.var.push(a), i.push(at), n.push(e))
...
var pt = (e) =>
  ...
  mt = (e, t) =>
    typeof e == `number` ? (t?.trim().endsWith(`/`) ? e : 0) : pt(e);
function ht(e) {
  let t = lt(e);
  return dt(t)(t.values.map((e, n) => mt(e, t.split[n])));
}
var R = { test: nt, parse: ut, createTransformer: ft, getAnimatableNone: ht };
function gt(e, t, n) {
  return (
    n < 0 && (n += 1),
    n > 1 && --n,
...
var jt = (e, t) => {
  ...
  return r.indexes.var.length === i.indexes.var.length &&
    ...
    ? (wt.has(e) && !i.values.length) || (wt.has(t) && !r.values.length)
      ? Tt(e, t)
      : C(Ot(At(r, i), i.values), n)
    : (`${e}${t}`, vt(e, t));
};
function Mt(e, t, n) {
...
function Kt(e) {
  ...
  if (!Gt(e, Wt) && Gt(e, Ut))
    if (((t.velocity = 0), e.visualDuration)) {
      ...
      t = { ...t, mass: B.mass, stiffness: i, damping: a };
    } else {
      let n = Ht({ ...e, velocity: 0 });
...
qt.applyToOptions = (e) => {
  let t = Lt(e, 100, qt);
  return (
    (e.ease = t.ease), (e.duration = E(t.duration)), (e.type = `keyframes`), e
  );
};
var Jt = 5;
function Yt(e, t, n) {
...
function Zt(e, t, n) {
  ...
  for (let n = 0; n < a; n++) {
    let a = i(e[n], e[n + 1]);
    t && (a = C(Array.isArray(t) ? t[n] || x : t, a)), r.push(a);
  }
  return r;
}
...
var sn = { decay: Xt, inertia: Xt, tween: rn, keyframes: rn, spring: qt };
function cn(e) {
...
var ln = class {
  ...
  dn = class extends ln {
    ...
    initAnimation() {
      ...
      s !== rn &&
        typeof o[0] != `number` &&
        ((this.mixKeyframes = C(un, Mt(o[0], o[1]))), (o = [0, 100]));
    ...
    tick(e, t = !1) {
      ...
      return (
        C && p !== Xt && (x.value = on(l, this.options, g, this.speed)),
        h && h(x.value),
        C && this.finish(),
        x
      );
...
function Nn() {
  ...
  (jn = !1), (An = !1), U.forEach((e) => e.complete(Mn)), U.clear();
}
function Pn() {
  U.forEach((e) => {
...
var In = class {
    ...
    scheduleResolve() {
      (this.state = `scheduled`),
        this.isAsync
          ? (U.add(this), An || ((An = !0), k.read(Pn), k.resolveKeyframes(Nn)))
...
function qn(
  ...
  c && (u.offset = c);
  let d = Kn(s, i);
  Array.isArray(d) && (u.easing = d), O.value && N.waapi++;
  let f = {
    delay: r,
    duration: i,
...
var Xn = class extends ln {
  ...
  Zn = { anticipate: de, backInOut: ue, circInOut: me };
function Qn(e) {
  return e in Zn;
}
function $n(e) {
...
function cr(e) {
  for (let t = 0; t < e.length; t++)
    if (typeof e[t] == `string` && sr.test(e[t])) return !0;
  return !1;
}
var lr = new Set([
    `color`,
...
var fr = 40,
  pr = class extends ln {
    constructor({
      ...
      (this.keyframeResolver = new (l?.KeyframeResolver || In)(
        o,
    ...
    get animation() {
      return (
        this._animation || (this.keyframeResolver?.resume(), Fn()),
        this._animation
      );
    }
    get duration() {
...
var vr = { type: `spring`, stiffness: 500, damping: 25, restSpeed: 10 },
  ...
  br = { type: `keyframes`, duration: 0.8 },
...
function Er(e) {
  for (let t in e) if (!Tr.has(t)) return !0;
  return !1;
}
var Dr =
  (e, t, n, r = {}, i, a) =>
  (o) => {
    ...
    if (
      ((u.type === !1 || (u.duration === 0 && !u.repeatDelay)) &&
        (ar(u), u.delay === 0 && (d = !0)),
      (g.instantAnimations || g.skipAnimations || i?.shouldSkipAnimations) &&
        ((d = !0), ar(u), (u.delay = 0)),
  ...
  Pr = class {
    ...
    setCurrent(e) {
      (this.current = e),
        ...
        this.canTrackVelocity === null &&
          e !== void 0 &&
          (this.canTrackVelocity = Mr(this.current));
    }
...
function Gr(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (let t in s) {
    let r = e.getValue(t, e.latestValues[t] ?? null),
      i = s[t];
    if (i === void 0 || (d && Wr(d, t))) continue;
    let o = { delay: n, ...wr(a || {}, t) },
      c = r.get();
    if (
      c !== void 0 &&
      !r.isAnimating() &&
    ...
    r.start(Dr(t, r, i, p && Ar.has(t) ? { type: !1 } : o, e, f));
    let m = r.animation;
    m && u.push(m);
  }
  if (o) {
...
var Yr = { test: (e) => e === `auto`, parse: (e) => e },
  Xr = (e) => (t) => t.test(e),
...
function ui(e, t) {
  let n = ci(e);
  return (
    li.has(n) || (n = R), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0
  );
}
...
function fi(e, t, n) {
  ...
  if (i && n) for (let r of t) e[r] = ui(n, i);
}
var pi = class extends In {
  ...
  readKeyframes() {
    ...
    for (let n = 0; n < e.length; n++) {
      let r = e[n];
      if (typeof r == `string` && ((r = r.trim()), Ne(r))) {
  ...
  resolveNoneKeyframes() {
    let { unresolvedKeyframes: e, name: t } = this,
      n = [];
    for (let t = 0; t < e.length; t++) (e[t] === null || $r(e[t])) && n.push(t);
    n.length && fi(e, n, t);
  }
  measureInitialState() {
...
function Ii(e, t, n = {}) {
  let [r, i, a] = xi(e, n),
    o = (e) => {
      ...
      if (!Pi(e) || Fi.has(e)) return;
      Ai.add(r), n.stopPropagation && Fi.add(e);
      let a = t(r, e),
        o = (e, t) => {
          window.removeEventListener(`pointerup`, s),
            window.removeEventListener(`pointercancel`, c),
            Ai.has(r) && Ai.delete(r),
            Pi(e) && typeof a == `function` && a(e, { success: t });
        },
        s = (e) => {
          o(
            e,
  ...
  return (
    r.forEach((e) => {
      (n.useGlobalTarget ? window : e).addEventListener(`pointerdown`, o, i),
        gi(e) &&
          (e.addEventListener(`focus`, (e) => Ni(e, i)),
...
function Ki(e, t) {
  ...
  return (
    n.forEach((e) => {
      let n = Ri.get(e);
      n || ((n = new Set()), Ri.set(e, n)), n.add(t), zi?.observe(e);
    }),
    () => {
      n.forEach((e) => {
        let n = Ri.get(e);
  ...
  return (
    ...
    () => {
      qi.delete(e),
        !qi.size &&
          typeof Ji == `function` &&
          (window.removeEventListener(`resize`, Ji), (Ji = void 0));
    }
  );
}
function Zi(e, t) {
...
var $i = [...Zr, L, R],
  ea = (e) => $i.find(Xr(e)),
  ta = () => ({ translate: 0, scale: 1, origin: 0, originPoint: 0 }),
  na = () => ({ x: ta(), y: ta() }),
  ra = () => ({ min: 0, max: 0 }),
  J = () => ({ x: ra(), y: ra() }),
  ia = new WeakMap();
...
var ba = class {
    ...
    readValue(e, t) {
      ...
      return (
        n != null &&
          (typeof n == `string` && (_(n) || y(n))
            ? (n = parseFloat(n))
            : !ea(n) && R.test(t) && (n = ui(e, t)),
    ...
    on(e, t) {
      return (
        this.events[e] || (this.events[e] = new T()), this.events[e].add(t)
      );
    }
    notify(e, ...t) {
...
function Ia(e, t, n, r = !1) {
  ...
  t.x < Fa && t.x > Pa && (t.x = 1), t.y < Fa && t.y > Pa && (t.y = 1);
}
function X(e, t) {
  (e.min += t), (e.max += t);
}
...
function Ga(e, t, n) {
  ...
  if (
    (t.transform ||
      (o || n
        ? (r.transform = Wa(t, e.transform, n))
        : (r.transform &&= `none`)),
    s)
  ) {
...
var eo = class extends xa {
    ...
    readValueFromInstance(e, t) {
      if (Tn.has(t)) return this.projection?.isProjecting ? bn(t) : Sn(e, t);
      {
        let n = $a(e),
...
function ao(
  ...
  for (let e of io) d[e] !== void 0 && ((f[e] = d[e]), delete d[e]);
  t !== void 0 && (d.x = t),
    n !== void 0 && (d.y = n),
    r !== void 0 && (d.scale = r),
...
function co(e, t, n, r) {
  Ka(e, t, void 0, r);
  for (let n in t.attrs) e.setAttribute(oo.has(n) ? n : Vr(n), t.attrs[n]);
}
function lo(e, t, n) {
  let r = Qa(e, t, n);
  for (let n in e)
...
var uo = class extends xa {
    ...
    readValueFromInstance(e, t) {
      ...
      return (t = oo.has(t) ? t : Vr(t)), e.getAttribute(t);
    }
    scrapeMotionValuesFromProps(e, t, n) {
      return lo(e, t, n);
    }
...
function _o(e) {
  return (t) =>
    Promise.all(t.map(({ animation: t, options: n }) => Jr(e, t, n)));
}
function vo(e) {
  let t = _o(e),
    n = xo(),
...
function jo(e, t, n, r = 0.5) {
  (e.origin = r),
    ...
    ((e.translate >= Oo && e.translate <= ko) || isNaN(e.translate)) &&
      (e.translate = 0);
}
function Mo(e, t, n, r) {
...
function Po(e, t, n, r) {
  No(e.x, t.x, n.x, r?.x), No(e.y, t.y, n.y, r?.y);
}
...
function Io(e, t, n, r) {
  Fo(e.x, t.x, n.x, r?.x), Fo(e.y, t.y, n.y, r?.y);
}
...
function Ro(e, t = 0, n = 1, r = 0.5, i, a = e, o = e) {
  if (
    (F.test(t) && ((t = parseFloat(t)), (t = z(o.min, o.max, t / 100) - o.min)),
    typeof t != `number`)
  )
    return;
...
function ns(e, t, n, r, i, a) {
  i
    ? ((e.opacity = z(0, n.opacity ?? 1, is(r))),
      (e.opacityExit = z(t.opacity ?? 1, 0, as(r))))
...
var ps = class {
  ...
  hs = { nodes: 0, calculatedTargetDeltas: 0, calculatedProjections: 0 },
  gs = [``, `X`, `Y`, `Z`],
  _s = 1e3,
  vs = 0;
function ys(e, t, n, r) {
...
function xs({
  ...
  return class {
      ...
      (this.id = vs++),
        ...
        (this.updateProjection = () => {
          (this.projectionUpdateScheduled = !1),
            O.value &&
              (hs.nodes =
                hs.calculatedTargetDeltas =
                hs.calculatedProjections =
                  0),
    ...
    mount(t) {
      ...
      (this.isSVG = Li(t) && !Qi(t)), (this.instance = t);
        ...
        k.read(() => {
          ...
          e(t, () => {
            ...
            e !== r &&
              ...
              n && n(),
              (n = ds(i, 250)),
              ms.hasAnimatedSinceResize &&
                ((ms.hasAnimatedSinceResize = !1), this.nodes.forEach(Ms)));
          });
      }
          ...
          this.addEventListener(
            ...
            ({
              ...
              if (
                ...
                let t = { ...wr(a, `layout`), onPlay: o, onComplete: s };
    ...
    didUpdate() {
      this.updateScheduled ||
        ((this.updateScheduled = !0), _i.read(this.scheduleUpdate));
    }
    clearAllSnapshots() {
    ...
    removeElementScroll(e) {
      ...
      for (let n = 0; n < this.path.length; n++) {
        ...
        r !== this.root &&
          i &&
          a.layoutScroll &&
          (i.wasRoot && Z(t, e), X(t.x, i.offset.x), X(t.y, i.offset.y));
      }
      return t;
    }
    ...
    removeTransform(e) {
      ...
      for (let e = 0; e < this.path.length; e++) {
        let n = this.path[e];
        if (!Da(n.latestValues)) continue;
        let r;
        n.instance &&
          (Ea(n.latestValues) && n.updateSnapshot(),
          (r = J()),
          Z(r, n.measurePageBox())),
          Ho(t, n.latestValues, n.snapshot?.layoutBox, r);
      }
      return Da(this.latestValues) && Ho(t, this.latestValues), t;
    }
    setTargetDelta(e) {
      (this.targetDelta = e),
    ...
    calcProjection() {
      ...
      !this.projectionDelta || !this.prevProjectionDelta
        ...
        : (Co(this.prevProjectionDelta.x, this.projectionDelta.x),
          Co(this.prevProjectionDelta.y, this.projectionDelta.y)),
        Mo(this.projectionDelta, this.layoutCorrected, s, this.latestValues),
        (this.treeScale.x !== a ||
          this.treeScale.y !== o ||
          !Xo(this.projectionDelta.x, this.prevProjectionDelta.x) ||
          !Xo(this.projectionDelta.y, this.prevProjectionDelta.y)) &&
          ((this.hasProjected = !0),
          this.scheduleRender(),
    ...
    setAnimationOrigin(e, t = !1) {
      ...
      (this.mixTargetDelta = (t) => {
        ...
        Ls(a.x, e.x, n),
          ...
          s &&
            ((this.animationValues = i), ns(i, r, this.latestValues, n, u, l)),
          this.root.scheduleUpdateProjection(),
          this.scheduleRender(),
    ...
    startAnimation(e) {
      this.notifyListeners(`animationStart`),
        ...
        (this.pendingAnimation &&= (A(this.pendingAnimation), void 0)),
    ...
    applyTransformsToTarget() {
      ...
      if (!(!t || !n || !r)) {
        if (
          ...
          this.layout &&
          r &&
          Ks(this.options.animationType, this.layout.layoutBox, r.layoutBox)
        ) {
          n = this.target || J();
    ...
    applyProjectionStyles(e, t) {
      ...
      this.options.layoutId &&
        (e.pointerEvents = r === this ? fs(t?.pointerEvents) || `` : `none`);
    }
    clearSnapshot() {
...
function Ks(e, t, n) {
  return (
    e === `position` || (e === `preserve-aspect` && !Ao(Yo(t), Yo(n), 0.2))
  );
}
function qs(e) {
...
var $s = (0, s.createContext)({ strict: !1 }),
  ec = {
    animation: [
      `animate`,
      `variants`,
...
function nc() {
  if (tc) return;
  let e = {};
  for (let t in ec) e[t] = { isEnabled: (e) => ec[t].some((t) => !!e[t]) };
  va(e), (tc = !0);
}
function rc() {
  return nc(), ya();
...
function hc(e) {
  let { initial: t, animate: n } = mc(e, (0, s.useContext)(pc));
  return (0, s.useMemo)(() => ({ initial: t, animate: n }), [gc(t), gc(n)]);
}
function gc(e) {
  return Array.isArray(e) ? e.join(` `) : e;
}
var _c = () => ({ style: {}, transform: {}, transformOrigin: {}, vars: {} });
function vc(e, t, n) {
  for (let r in t) !K(t[r]) && !Za(r, n) && (e[r] = t[r]);
}
...
function bc(e, t) {
  let n = e.style || {},
    r = {};
  return vc(r, n, e), Object.assign(r, yc(e, t)), r;
}
function xc(e, t) {
  let n = {},
    r = bc(e, t);
...
function Cc(e, t, n, r) {
  let i = (0, s.useMemo)(() => {
    let n = Sc();
    return (
      ao(n, t, so(r), e.transformTemplate, e.style),
      { ...n.attrs, style: { ...n.style } }
    );
  }, [t]);
  if (e.style) {
    let t = {};
    vc(t, e.style, e), (i.style = { ...t, ...i.style });
  }
  return i;
}
var wc = [
...
var kc = (e) => (t, n) => {
  ...
  Ac = kc({ scrapeMotionValuesFromProps: Qa, createRenderState: _c }),
  jc = kc({ scrapeMotionValuesFromProps: lo, createRenderState: Sc }),
...
function Rc(e) {
  if (e) return e.options.allowProjection === !1 ? Rc(e.parent) : e.projection;
}
function zc(e, { forwardMotionProps: t = !1, type: n } = {}, r, i) {
  ...
  function l(n, l) {
    let u,
      d = { ...(0, s.useContext)(Zs), ...n, layoutId: Bc(n) },
      { isStatic: f } = d,
      p = hc(n),
      m = c(n, f);
    ...
    return (0, o.jsxs)(pc.Provider, {
      value: p,
      children: [
        u && p.visualElement
          ? (0, o.jsx)(u, { visualElement: p.visualElement, ...d })
          : null,
        Ec(e, n, Nc(m, p.visualElement, l), m, f, t, a),
      ],
    });
  }
...
function Uc(e, t) {
  ...
  return new Proxy((e, t) => r(e, t), {
    get: (i, a) =>
      a === `create`
        ? r
        : (n.has(a) || n.set(a, zc(a, void 0, e, t)), n.get(a)),
  });
}
var Wc = (e, t) =>
    t.isSVG ?? Tc(e)
      ? new uo(t)
      : new eo(t, { allowProjection: e !== s.Fragment }),
  Gc = class extends Y {
    constructor(e) {
  ...
  Kc = 0,
  qc = {
    animation: { Feature: Gc },
    exit: {
      Feature: class extends Y {
        constructor() {
          super(...arguments), (this.id = Kc++), (this.isExitComplete = !1);
        }
        update() {
  ...
  tl = class {
    constructor(
      ...
      u && u(e, il(s, this.history)),
        (this.removeListeners = C(
          Xc(this.contextWindow, `pointermove`, this.handlePointerMove),
          Xc(this.contextWindow, `pointerup`, this.handlePointerUp),
          Xc(this.contextWindow, `pointercancel`, this.handlePointerUp)
        )),
    ...
    startScrollTracking(e) {
      ...
      for (; t; ) {
        ...
        (el.has(e.overflowX) || el.has(e.overflowY)) &&
...
function ul(e, { top: t, left: n, bottom: r, right: i }) {
  return { x: ll(e.x, n, i), y: ll(e.y, t, r) };
}
function dl(e, t) {
  let n = t.min - e.min,
    r = t.max - e.max;
...
function fl(e, t) {
  return { x: dl(e.x, t.x), y: dl(e.y, t.y) };
}
function pl(e, t) {
  let n = 0.5,
    r = Q(e),
  ...
  return (
    i > r
      ? (n = w(t.min, t.max - r, e.min))
      : r > i && (n = w(e.min, e.max - i, t.min)),
    m(0, 1, n)
  );
}
function ml(e, t) {
...
function gl(e = hl) {
  return (
    e === !1 ? (e = 0) : e === !0 && (e = hl),
    { x: _l(e, `left`, `right`), y: _l(e, `top`, `bottom`) }
  );
}
function _l(e, t, n) {
  return { min: vl(e, t), max: vl(e, n) };
}
function vl(e, t) {
...
var yl = new WeakMap(),
  bl = class {
    ...
    start(e, { snapToCursor: t = !1, distanceThreshold: n } = {}) {
      ...
      let i = (e) => {
          t && this.snapToCursor(Jc(e).point), this.stopAnimation();
        },
        a = (e, t) => {
    ...
    updateAxis(e, t, n) {
      ...
      if (!n || !Cl(e, r, this.currentDirection)) return;
    ...
    resolveConstraints() {
      ...
      e && Fc(e)
        ...
        : e && n
        ? (this.constraints = ul(n.layoutBox, e))
        : (this.constraints = !1),
        (this.elastic = gl(t)),
        r !== this.constraints &&
          !Fc(e) &&
          ...
          $((e) => {
            this.constraints !== !1 &&
              ...
              (this.constraints[e] = ml(n.layoutBox[e], this.constraints[e]));
          });
    }
    resolveRefConstraints() {
      ...
      if (t) {
        let e = t(Ca(a));
        (this.hasMutatedConstraints = !!e), e && (a = Sa(e));
      }
      return a;
    }
    startAnimation(e) {
      let {
        ...
        s = this.constraints || {},
        c = $((o) => {
          if (!Cl(o, t, this.currentDirection)) return;
          let c = (s && s[o]) || {};
    ...
    snapToCursor(e) {
      $((t) => {
        ...
        if (!Cl(t, n, this.currentDirection)) return;
    ...
    scalePositionWithinConstraints() {
      ...
      if (!Fc(t) || !n || !this.constraints) return;
      this.stopAnimation();
      let r = { x: 0, y: 0 };
      $((e) => {
...
var Tl = class extends Y {
  ...
  Dl = class extends Y {
    ...
    mount() {
      this.removePointerDownListener = Xc(
        this.node.current,
        `pointerdown`,
...
function Al(e) {
  ...
  return (0, o.jsx)(kl, {
    ...e,
    layoutGroup: r,
    switchLayoutGroup: (0, s.useContext)(Pc),
    isPresent: t,
    safeToRemove: n,
  });
}
var jl = {
  pan: { Feature: Dl },
  drag: { Feature: Tl, ProjectionNode: Xs, MeasureLayout: Al },
};
function Ml(e, t, n) {
  let { props: r } = e;
  e.animationState &&
...
var Nl = class extends Y {
    mount() {
      ...
      e &&
        (this.unmount = Ci(
          e,
          (e, t) => (Ml(this.node, t, `Start`), (e) => Ml(this.node, e, `End`))
        ));
    }
    unmount() {}
  },
...
function Vl({ root: e, ...t }) {
  ...
  let r = Rl.get(n),
    i = JSON.stringify(t);
  return r[i] || (r[i] = new IntersectionObserver(Bl, { root: e, ...t })), r[i];
}
function Hl(e, t, n) {
  let r = Vl(t);
  return (
...
var Kl = {
  ...
  ql = { layout: { ProjectionNode: Xs, MeasureLayout: Al } },
  Jl = Uc({ ...qc, ...Kl, ...jl, ...ql }, Wc);
export {
  k as A,
  d as B,
  en as C,
