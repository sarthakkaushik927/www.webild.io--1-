...
var d = class {
  ...
  advance(e) {
    ...
    if (this.duration && this.easing) {
      ...
      this.lerp
        ? ((this.value = l(this.value, this.to, this.lerp * 60, e)),
...
var p = class {
    ...
    constructor(e, t, { autoResize: n = !0, debounce: r = 250 } = {}) {
      (this.wrapper = e),
        (this.content = t),
        n &&
          ((this.debouncedResize = f(this.resize, r)),
...
var v = class {
  ...
  b = class {
    ...
    constructor({
      ...
      gestureOrientation: m = f === `horizontal` ? `both` : `vertical`,
      touchMultiplier: h = 1,
      wheelMultiplier: g = 1,
      autoResize: _ = !0,
      prevent: b,
      ...
      (window.lenisVersion = o),
        ...
        (this.dimensions = new p(e, t, { autoResize: _ })),
    ...
    get scroll() {
      return this.options.infinite
        ? u(this.animatedScroll, this.limit)
        : this.animatedScroll;
    }
    get progress() {
...
function C(e) {
  let [t, n] = (0, a.useState)(e.get());
  return (0, a.useEffect)(() => e.subscribe((e) => n(e)), [e]), t;
}
  ...
  E = (0, a.forwardRef)(
    (
      ...
      (0, a.useImperativeHandle)(
        s,
        () => ({ wrapper: c.current, content: l.current, lenis: u }),
        [u]
      ),
        (0, a.useEffect)(() => {
          let e = new b({
            ...n,
            ...(c.current &&
              l.current && { wrapper: c.current, content: l.current }),
            autoRaf: n?.autoRaf ?? r,
          });
          return (
            d(e),
      ...
      return (
        (0, a.useEffect)(() => {
          if (t && u)
            return (
              T.set({ lenis: u, addCallback: p, removeCallback: m }),
              () => T.set(null)
            );
        }, [t, u, p, m]),
        (0, a.useEffect)(() => {
          if (!u) return;
          let e = (e) => {
            for (let { callback: t } of f.current) t(e);
          };
          return (
            u.on(`scroll`, e),
            () => {
        ...
        e
          ? (0, x.jsx)(w.Provider, {
              value: { lenis: u, addCallback: p, removeCallback: m },
              children:
                t && t !== `asChild`
                  ? e
                  : (0, x.jsx)(`div`, {
                      ...
                      ...o,
                      children: (0, x.jsx)(`div`, { ref: l, children: e }),
                    }),
            })
          : null
      );
  ...
  return (r) => {
    if (e) {
      ...
      if (i)
        ...
        e.startsWith(`#`)
          ? (r?.preventDefault(), s(e.slice(1), 50))
          : (r?.preventDefault(), s(e, 50));
    }
    t?.();
  };
};
