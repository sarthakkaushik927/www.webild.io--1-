...
function _(e, t, n, r = {}) {
  let { window: i = document.defaultView, v5Compat: a = !1 } = r,
    ...
    u = null,
    d = f();
  d ?? ((d = 0), o.replaceState({ ...o.state, idx: d }, ``));
  function f() {
  ...
  function h() {
    ...
    let e = f(),
      t = e == null ? null : e - d;
    (d = e), u && u({ action: l, location: b.location, delta: t });
  }
  function g(e, t) {
    l = `PUSH`;
  ...
  let b = {
    ...
    listen(e) {
      ...
      return (
        ...
        (u = e),
        () => {
          i.removeEventListener(s, h), (u = null);
        }
      );
    },
    createHref(e) {
...
function S(e, t = [], n = [], r = ``, i = !1) {
  let a = (e, a, o = i, s) => {
    ...
    e.children &&
      ...
      !(e.path == null && !e.index) &&
        t.push({ path: l, score: ae(l, e.index), routesMeta: d });
  };
  return (
    e.forEach((e, t) => {
      if (e.path === `` || !e.path?.includes(`?`)) a(e, t);
      else for (let n of C(e.path)) a(e, t, !0, n);
    }),
    t
  );
}
...
function ae(e, t) {
  ...
  return (
    ...
    n
      .filter((e) => !ie(e))
      .reduce((e, t) => e + (T.test(t) ? E : t === `` ? te : ne), r)
  );
}
function oe(e, t) {
...
function de(e, t = `/`) {
  ...
  return (
    n
      ? ((n = n.replace(/\/\/+/g, `/`)),
        (a = n.startsWith(`/`) ? fe(n.substring(1), `/`) : fe(n, t)))
      : (a = t),
    { pathname: a, search: he(r), hash: ge(i) }
  );
}
function fe(e, t) {
...
var Ee = n.createContext({ isTransitioning: !1 });
...
var L = n.createContext({ outlet: null, matches: [], isDataRoute: !1 });
L.displayName = `Route`;
...
function Pe(e, { relative: t } = {}) {
  ...
  let { basename: r, navigator: i } = n.useContext(F),
    { hash: a, pathname: o, search: s } = H(e, { relative: t }),
    c = o;
  return (
    r !== `/` && (c = o === `/` ? r : M([r, o])),
  ...
  return (
    ...
    n.useCallback(
      (n, i = {}) => {
        ...
        e == null &&
          t !== `/` &&
          (c.pathname = c.pathname === `/` ? t : M([t, c.pathname])),
...
function ze(e) {
  ...
  return n.useMemo(
    () => t && n.createElement(Re.Provider, { value: e }, t),
    [t, e]
  );
}
function Be() {
...
var We = n.createElement(Ue, null),
  Ge = class extends n.Component {
    ...
    render() {
      ...
      return this.context ? n.createElement(Ke, { error: e }, t) : t;
    }
  };
Ge.contextType = we;
var U = new WeakMap();
...
function qe({ routeContext: e, match: t, children: r }) {
  ...
  return (
    ...
    n.createElement(L.Provider, { value: e }, r)
  );
}
function Je(e, t = [], r) {
  let i = r?.state;
...
function K(e) {
  ...
  return (
    u(n.route.id, `${e} can only be used on routes that contain a unique "id"`),
    n.route.id
  );
}
function Ze() {
...
n.useOptimistic, n.memo(it);
function it({ routes: e, future: t, state: n, isStatic: r, onError: i }) {
  return He(e, void 0, { state: n, isStatic: r, onError: i, future: t });
}
function at({ to: e, replace: t, state: r, relative: i }) {
  ...
  return (
    n.useEffect(() => {
      c(JSON.parse(f), { replace: t, state: r, relative: i });
    }, [c, f, i, t, r]),
    null
  );
}
...
function ct({
  ...
  return (
    d(
      y != null,
      `<Router basename="${c}"> is not able to match the URL "${f}${p}${m}" because it does not start with the basename, so the <Router> won't render anything.`
    ),
    y == null
      ? null
      : n.createElement(
          F.Provider,
          { value: l },
          n.createElement(I.Provider, { children: t, value: y })
        )
  );
}
...
function ut(e, t = []) {
  ...
  return (
    n.Children.forEach(e, (e, i) => {
      ...
      e.props.children && (o.children = ut(e.props.children, a)), r.push(o);
    }),
    r
  );
}
...
function Nt(e, t) {
  let n = new Set(),
    r = new Set(t);
  return e.reduce((e, i) => {
    if (t && !Et(i) && i.as === `script` && i.href && r.has(i.href)) return e;
...
function It() {
  ...
  return (
    Ct(e, `You must render this element inside a <HydratedRouter> element`), e
  );
}
function Lt(e, t) {
...
function Rt({ page: e, ...t }) {
  ...
  return a
    ? r
      ? n.createElement(Bt, { page: e, matches: a, ...t })
      : n.createElement(Vt, { page: e, matches: a, ...t })
    : null;
}
function zt(e) {
...
function Wt({
  ...
  let a = n.useRef();
  a.current ??= l({ window: i, v5Compat: !0 });
  let o = a.current,
    [s, c] = n.useState({ action: o.action, location: o.location }),
    u = n.useCallback(
      (e) => {
  ...
  return (
    n.useLayoutEffect(() => o.listen(u), [o, u]),
    n.createElement(ct, {
      basename: e,
      children: t,
      location: s.location,
...
var Kt = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  qt = n.forwardRef(function (
    ...
    return w && !y
      ? n.createElement(n.Fragment, null, re, n.createElement(Rt, { page: x }))
      : re;
  });
qt.displayName = `Link`;
var Jt = n.forwardRef(function (
  {
    "aria-current": e = `page`,
    caseSensitive: t = !1,
    className: r = ``,
...
function Xt({ getKey: e, storageKey: t, ...r }) {
  ...
  return n.createElement(`script`, {
    ...
    dangerouslySetInnerHTML: {
      __html: `(${l})(${St(JSON.stringify(t || on))}, ${St(
        JSON.stringify(c)
      )})`,
    },
  });
...
function rn() {
  ...
  return n.useCallback(
    async (e, n = {}) => {
      ...
      n.navigate === !1
        ? await i(n.fetcherKey || nn(), r, n.action || o, {
            unstable_defaultShouldRevalidate:
              n.unstable_defaultShouldRevalidate,
